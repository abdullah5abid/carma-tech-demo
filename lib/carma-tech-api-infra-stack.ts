...
export class CarmaApiDemoStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    this.ecrRepository = new Repository(this, 'CarmaApiDemoImageRepository', {
      repositoryName: 'carmaapidemo-lambda-assets-repo',
      lifecycleRules: [{
  ...
  createLambdaPipeLine() {
    const carmaApiDemoCodepipeline = new Pipeline(this, 'Pipeline', {
      pipelineName: 'carmaApiDemoProdCodePipeline',
    });
    ...
    carmaApiDemoCodepipeline.addStage({
      stageName: "Source",
  ...
  private createCodeBuildProject = (): PipelineProject => {
    this.codeBuildProject = new PipelineProject(this, 'CodeBuildProject', {
      projectName: 'carmaApiDemo-Lambda-Image-Build',
      environment: {
        privileged: true,
